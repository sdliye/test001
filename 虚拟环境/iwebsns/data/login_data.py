...
'''
  ...
  @desc:
'''
from iwebsns.config.config import data_file
...
class Datas:
    ...
    def connect_files(self):
        import pymysql
        self.db = pymysql.connect(host='localhost', port=3306, user='root', password='root', database='T107',
                                  charset='utf8')
        # 创建游标
